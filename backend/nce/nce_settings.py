...
Cambios respecto a la versión anterior:
  - NCE_USE_SFTP default = true  (el servidor solo acepta SFTP)
  - NCE_PORT default = 22
  - COLLECTION_INTERVAL_MINUTES = 5 (sincronizado con granularidad del NCE)
  - PM_IG67_5 y PM_IG7106_15 / PM_IG7106_5 agregados al catálogo
    (se encontraron en el servidor durante diagnóstico)
"""
import os
...
# 5 minutos = granularidad de los archivos PM_IG45046_5 y PM_IG7106_5
...
# enabled=False → ignorado (activar cuando se necesite)
PM_CATALOG = [
    {
        'code':        'PM_IG45046_5',
    ...
    },
    {
        ...
        'kpi_cols':    [],
        'granularity': '5min',
        'enabled':     False,   # activar cuando se necesite
    },
    {
        'code':        'PM_IG7106_5',
